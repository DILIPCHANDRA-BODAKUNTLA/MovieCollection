"""
Django settings for user_collections project.
...
elif os.environ.get(ENV_PARAM) in ['LOCAL', 'local']:
    environ.Env.read_env(os.path.join(BASE_DIR, '.env_local'))
else:
    environ.Env.read_env(os.path.join(BASE_DIR, '.env_test'))

env = environ.Env(
)

ENVIRONMENT = env('ENVIRONMENT')
SIMPLE_JWT = {"SIGNING_KEY": env("SIGNING_KEY"),
...
SECRET_KEY = 'django-insecure-ab!7wk5&6chairen&#gu_805u$+#si34e0mi)_dtv_s02bmqa!'
...
MIDDLEWARE = [
    ...
    'movie_collection.middleware.MiddlewareAPI'
]

ROOT_URLCONF = 'user_collections.urls'
...
WSGI_APPLICATION = 'user_collections.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'movie_collection.authentication.CustomAuthentication',
